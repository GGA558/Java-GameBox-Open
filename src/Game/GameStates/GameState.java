...
public class GameState extends State {
    ...
    public void refresh() {
        ...
        uiManager.addObjects(new UIImageButton(((handler.getWidth() / 2)) - ((handler.getWidth() / 15)) + 4 , (handler.getHeight() /2)-(handler.getHeight() /45), handler.getWidth()/8, handler.getHeight()/8, Images.officialPacLogo, new ClickListlener() {
            @Override
            public void onClick() {
                handler.getMouseManager().setUimanager(null);
